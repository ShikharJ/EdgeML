...
void q_face_detection(char* const mem_buf) {
  ...
  q7xq15_q7_convolution((Q7_T*)mem_buf, CBR1F, (Q7_T*)(mem_buf + 76800),
    CONV2D_N, CBR1F_H, CBR1F_W, CBR1F_CIN, CBR1F_HF,
    ...
    CBR1F_WSTRIDE, CBR1F_HDILATION, CBR1F_WDILATION,
  ...
  q7xq15_q7_convolution((Q7_T*)mem_buf, CBR1W, (Q7_T*)mem_buf,
    CONV2D_N, CONV2D_HOUT, CONV2D_WOUT, CONV2D_COUT,
    ...
    CBR1W_WSTRIDE, CBR1W_HDILATION, CBR1W_WDILATION,
  ...
  for (int patchX = 0; (patchX < 29); patchX++) {
    ...
    for (int patchY = 0; (patchY < 39); patchY++) {
      ...
      q7xq15_q15_rnnpool_block((Q7_T*)(mem_buf + 76800 + ((2560 * patchX) + (16 * patchY))),
        INPUT_CHANNELS, PATCH_DIM, 160, q7xq15_q15_fastgrnn, HIDDEN_DIM1,
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L2_F1, L2_W1, L2_B1, L2_F2, L2_W2,
    ...
    (Q15_T*)(mem_buf + 169050), L2_N, L2_H, L2_W, L2_CIN, L2_CTEMP, L2_HF,
    L2_WF, L2_COUT, L2_HOUT, L2_WOUT, L2_HPADL, L2_HPADR, L2_WPADL, L2_WPADR,
    L2_HSTRIDE, L2_WSTRIDE, L2_Limit1, L2_Limit2, L2_ShRU1, L2_ShRX1, L2_ShRU2,
    L2_ShRX2, L2_ShRU3, L2_ShRW3, L2_ShLU1, L2_ShLX1, L2_ShLU2, L2_ShLX2,
    L2_ShLU3, L2_ShLW3);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L3_F1, L3_W1, L3_B1, L3_F2, L3_W2,
    ...
    (Q15_T*)(mem_buf + 169050), L3_N, L3_H, L3_W, L3_CIN, L3_CTEMP, L3_HF,
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L4_F1, L4_W1, L4_B1, L4_F2, L4_W2,
    ...
    (Q15_T*)(mem_buf + 169050), L4_N, L4_H, L4_W, L4_CIN, L4_CTEMP, L4_HF,
    L4_WF, L4_COUT, L4_HOUT, L4_WOUT, L4_HPADL, L4_HPADR, L4_WPADL, L4_WPADR,
    L4_HSTRIDE, L4_WSTRIDE, L4_Limit1, L4_Limit2, L4_ShRU1, L4_ShRX1, L4_ShRU2,
    L4_ShRX2, L4_ShRU3, L4_ShRW3, L4_ShLU1, L4_ShLX1, L4_ShLU2, L4_ShLX2,
    L4_ShLU3, L4_ShLW3);
  ...
  q15_convolution((Q15_T*)mem_buf, D1CW, (Q15_T*)(mem_buf + 153600),
    ...
    D1CW_HDILATION, D1CW_WDILATION, D1CW_Scinput,
  ...
  q15_convolution((Q15_T*)mem_buf, D1LW, (Q15_T*)(mem_buf + 153600),
    ...
    D1LW_HDILATION, D1LW_WDILATION, D1LW_Scinput,
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L5_F1, L5_W1, L5_B1, L5_F2, L5_W2,
    ...
    (Q15_T*)(mem_buf + 168300), L5_N, L5_H, L5_W, L5_CIN, L5_CTEMP, L5_HF,
    L5_WF, L5_COUT, L5_HOUT, L5_WOUT, L5_HPADL, L5_HPADR, L5_WPADL, L5_WPADR,
    L5_HSTRIDE, L5_WSTRIDE, L5_Limit1, L5_Limit2, L5_ShRU1, L5_ShRX1, L5_ShRU2,
    L5_ShRX2, L5_ShRU3, L5_ShRW3, L5_ShLU1, L5_ShLX1, L5_ShLU2, L5_ShLX2,
    L5_ShLU3, L5_ShLW3);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L6_F1, L6_W1, L6_B1, L6_F2, L6_W2,
    ...
    (Q15_T*)(mem_buf + 168300), L6_N, L6_H, L6_W, L6_CIN, L6_CTEMP, L6_HF,
    L6_WF, L6_COUT, L6_HOUT, L6_WOUT, L6_HPADL, L6_HPADR, L6_WPADL, L6_WPADR,
    L6_HSTRIDE, L6_WSTRIDE, L6_Limit1, L6_Limit2, L6_ShRU1, L6_ShRX1, L6_ShRU2,
    L6_ShRX2, L6_ShRU3, L6_ShRW3, L6_ShLU1, L6_ShLX1, L6_ShLU2, L6_ShLX2,
    L6_ShLU3, L6_ShLW3);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L7_F1, L7_W1, L7_B1, L7_F2, L7_W2,
    ...
    (Q15_T*)(mem_buf + 168300), L7_N, L7_H, L7_W, L7_CIN, L7_CTEMP, L7_HF,
    L7_WF, L7_COUT, L7_HOUT, L7_WOUT, L7_HPADL, L7_HPADR, L7_WPADL, L7_WPADR,
    L7_HSTRIDE, L7_WSTRIDE, L7_Limit1, L7_Limit2, L7_ShRU1, L7_ShRX1, L7_ShRU2,
    L7_ShRX2, L7_ShRU3, L7_ShRW3, L7_ShLU1, L7_ShLX1, L7_ShLU2, L7_ShLX2,
    L7_ShLU3, L7_ShLW3);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L8_F1, L8_W1, L8_B1, L8_F2, L8_W2,
    ...
    (Q15_T*)(mem_buf + 168300), L8_N, L8_H, L8_W, L8_CIN, L8_CTEMP, L8_HF,
    L8_WF, L8_COUT, L8_HOUT, L8_WOUT, L8_HPADL, L8_HPADR, L8_WPADL, L8_WPADR,
    L8_HSTRIDE, L8_WSTRIDE, L8_Limit1, L8_Limit2, L8_ShRU1, L8_ShRX1, L8_ShRU2,
    L8_ShRX2, L8_ShRU3, L8_ShRW3, L8_ShLU1, L8_ShLX1, L8_ShLU2, L8_ShLX2,
    L8_ShLU3, L8_ShLW3);
  ...
  q15_convolution((Q15_T*)mem_buf, D2CW, (Q15_T*)(mem_buf + 168000),
    ...
    D2CW_HDILATION, D2CW_WDILATION, D2CW_Scinput,
  ...
  q15_convolution((Q15_T*)mem_buf, D2LW, (Q15_T*)(mem_buf + 172800),
    ...
    D2LW_HDILATION, D2LW_WDILATION, D2LW_Scinput,
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L9_F1, L9_W1, L9_B1, L9_F2, L9_W2,
    ...
    (Q15_T*)(mem_buf + 73050), L9_N, L9_H, L9_W, L9_CIN, L9_CTEMP, L9_HF, L9_WF,
    L9_COUT, L9_HOUT, L9_WOUT, L9_HPADL, L9_HPADR, L9_WPADL, L9_WPADR,
    L9_HSTRIDE, L9_WSTRIDE, L9_Limit1, L9_Limit2, L9_ShRU1, L9_ShRX1, L9_ShRU2,
    L9_ShRX2, L9_ShRU3, L9_ShRW3, L9_ShLU1, L9_ShLX1, L9_ShLU2, L9_ShLX2,
    L9_ShLU3, L9_ShLW3);
  ...
  q15xq7_q15_mbconv_block((Q15_T*)mem_buf, L10_F1, L10_W1, L10_B1, L10_F2,
    ...
    L10_CIN, L10_CTEMP, L10_HF, L10_WF, L10_COUT, L10_HOUT, L10_WOUT, L10_HPADL,
    L10_HPADR, L10_WPADL, L10_WPADR, L10_HSTRIDE, L10_WSTRIDE, L10_Limit1,
    L10_Limit2, L10_ShRU1, L10_ShRX1, L10_ShRU2, L10_ShRX2, L10_ShRU3,
    L10_ShRW3, L10_ShLU1, L10_ShLX1, L10_ShLU2, L10_ShLX2, L10_ShLU3,
    L10_ShLW3);
  ...
  q15xq7_q15_mbconv_block((Q15_T*)mem_buf, L11_F1, L11_W1, L11_B1, L11_F2,
    ...
    L11_CIN, L11_CTEMP, L11_HF, L11_WF, L11_COUT, L11_HOUT, L11_WOUT, L11_HPADL,
    L11_HPADR, L11_WPADL, L11_WPADR, L11_HSTRIDE, L11_WSTRIDE, L11_Limit1,
    L11_Limit2, L11_ShRU1, L11_ShRX1, L11_ShRU2, L11_ShRX2, L11_ShRU3,
    L11_ShRW3, L11_ShLU1, L11_ShLX1, L11_ShLU2, L11_ShLX2, L11_ShLU3,
    L11_ShLW3);
  ...
  q15_convolution((Q15_T*)(mem_buf + 96000), D3CW, (Q15_T*)(mem_buf + 61200),
    ...
    D3CW_HDILATION, D3CW_WDILATION, D3CW_Scinput,
  ...
  q15_convolution((Q15_T*)(mem_buf + 96000), D3LW, (Q15_T*)(mem_buf + 60000),
    ...
    D3LW_HDILATION, D3LW_WDILATION, D3LW_Scinput,
  ...
  q15xq7_q7_mbconv_block((Q15_T*)mem_buf, L12_F1, L12_W1, L12_B1, L12_F2,
    ...
    L12_CIN, L12_CTEMP, L12_HF, L12_WF, L12_COUT, L12_HOUT, L12_WOUT, L12_HPADL,
    L12_HPADR, L12_WPADL, L12_WPADR, L12_HSTRIDE, L12_WSTRIDE, L12_Limit1,
    L12_Limit2, L12_ShRU1, L12_ShRX1, L12_ShRU2, L12_ShRX2, L12_ShRU3,
    L12_ShRW3, L12_ShLU1, L12_ShLX1, L12_ShLU2, L12_ShLX2, L12_ShLU3,
    L12_ShLW3);
  ...
  q7_mbconv_block((Q7_T*)(mem_buf + 76800), L13_F1, L13_W1, L13_B1, L13_F2,
    ...
    L13_CIN, L13_CTEMP, L13_HF, L13_WF, L13_COUT, L13_HOUT, L13_WOUT, L13_HPADL,
    L13_HPADR, L13_WPADL, L13_WPADR, L13_HSTRIDE, L13_WSTRIDE, L13_Limit1,
    L13_Limit2, L13_ShRU1, L13_ShRX1, L13_ShRU2, L13_ShRX2, L13_ShRU3,
    L13_ShRW3, L13_ShLU1, L13_ShLX1, L13_ShLU2, L13_ShLX2, L13_ShLU3,
    L13_ShLW3);
  ...
  q7_mbconv_block((Q7_T*)(mem_buf + 76800), L14_F1, L14_W1, L14_B1, L14_F2,
    ...
    L14_CIN, L14_CTEMP, L14_HF, L14_WF, L14_COUT, L14_HOUT, L14_WOUT, L14_HPADL,
    L14_HPADR, L14_WPADL, L14_WPADR, L14_HSTRIDE, L14_WSTRIDE, L14_Limit1,
    L14_Limit2, L14_ShRU1, L14_ShRX1, L14_ShRU2, L14_ShRX2, L14_ShRU3,
    L14_ShRW3, L14_ShLU1, L14_ShLX1, L14_ShLU2, L14_ShLX2, L14_ShLU3,
    L14_ShLW3);
  ...
  q7xq15_q7_convolution((Q7_T*)(mem_buf + 76800), D4CW, (Q7_T*)(mem_buf + 4800),
    L14_N, L14_HOUT, L14_WOUT, L14_COUT, D4CW_HF, D4CW_WF,
    ...
    D4CW_WDILATION, D4CW_Scinput, D4CW_Scoutput, D4CW_Demote);
  ...
  q7xq15_q15_convolution((Q7_T*)(mem_buf + 76800), D4LW,
    (Q15_T*)(mem_buf + 2400), L14_N, L14_HOUT,
    L14_WOUT, L14_COUT, D4LW_HF, D4LW_WF, D4LW_CF, D4LW_COUT, L14_HOUT,
    L14_WOUT, D4LW_G, D4LW_HPADL, D4LW_HPADR, D4LW_WPADL, D4LW_WPADR,
    D4LW_HSTRIDE, D4LW_WSTRIDE, D4LW_HDILATION, D4LW_WDILATION, D4LW_Scinput,
    D4LW_Scoutput, D4LW_Demote);
