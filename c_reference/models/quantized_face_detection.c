...
void q_face_detection(char* const mem_buf) {
  ...
  q7xq15_q7_convolution((Q7_T*)mem_buf, CBR1F, (Q7_T*)(mem_buf + 76800),
    ...
    CBR1F_LScinput, CBR1F_LScoutput, CBR1F_LDemote);
  ...
  q7xq15_q7_t_add_vec((Q7_T*)(mem_buf + 76800), CBR1B, CONV2D_N, CONV2D_HOUT,
    ...
    CBR1B_Scret, CBR1B_LScten, CBR1B_LScvec, CBR1B_LScret);
  ...
  q7xq15_q7_convolution((Q7_T*)mem_buf, CBR1W, (Q7_T*)mem_buf, CONV2D_N,
    ...
    CBR1W_LScinput, CBR1W_LScoutput, CBR1W_LDemote);
  ...
  for (ITER_T patch_x = 0; (patch_x < 29); patch_x++) {
    for (ITER_T patch_y = 0; (patch_y < 39); patch_y++) {
      q7xq15_q15_rnnpool_block((Q7_T*)(mem_buf + 76800 + ((2560 * patch_x) + (16 * patch_y))),
        ...
        (const void*)(&RNN2_LOG_SCALES), (Q15_T*)(mem_buf + 153750),
        (Q15_T*)(mem_buf + 153900), ShR1, ShL1, ShR2, ShL2, LShR1, LShL1,
        LShR2, LShL2);
  ...
  q7xq15_q15_mbconv_block((Q7_T*)mem_buf, L1_F1, L1_W1, L1_B1, L1_F2, L1_W2,
    ...
    L1_ShLX1, L1_ShLU2, L1_ShLX2, L1_ShLU3, L1_ShLW3, L1_LShRU1, L1_LShRX1,
    L1_LShRU2, L1_LShRX2, L1_LShRU3, L1_LShRW3, L1_LShLU1, L1_LShLX1,
    L1_LShLU2, L1_LShLX2, L1_LShLU3, L1_LShLW3);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L2_F1, L2_W1, L2_B1, L2_F2,
    ...
    L2_ShLX1, L2_ShLU2, L2_ShLX2, L2_ShLU3, L2_ShLW3, L2_LShRU1, L2_LShRX1,
    L2_LShRU2, L2_LShRX2, L2_LShRU3, L2_LShRW3, L2_LShLU1, L2_LShLX1,
    L2_LShLU2, L2_LShLX2, L2_LShLU3, L2_LShLW3);

  // MBConv1 + MBConv2
  q15_t_add((Q15_T*)(mem_buf + 76800), (Q15_T*)mem_buf, L2_N, L2_HOUT, L2_WOUT,
    L2_COUT, (Q15_T*)(mem_buf + 76800), L2_Scten1, L2_Scten2, L2_Scret,
    L2_LScten1, L2_LScten2, L2_LScret);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L3_F1, L3_W1, L3_B1, L3_F2,
    ...
    L3_ShLX1, L3_ShLU2, L3_ShLX2, L3_ShLU3, L3_ShLW3, L3_LShRU1, L3_LShRX1,
    L3_LShRU2, L3_LShRX2, L3_LShRU3, L3_LShRW3, L3_LShLU1, L3_LShLX1,
    L3_LShLU2, L3_LShLX2, L3_LShLU3, L3_LShLW3);
  ...
  q15_t_add((Q15_T*)(mem_buf + 76800), (Q15_T*)mem_buf, L3_N, L3_HOUT, L3_WOUT,
    ...
    L3_LScten1, L3_LScten2, L3_LScret);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L4_F1, L4_W1, L4_B1, L4_F2,
    ...
    L4_ShLX1, L4_ShLU2, L4_ShLX2, L4_ShLU3, L4_ShLW3, L4_LShRU1, L4_LShRX1,
    L4_LShRU2, L4_LShRX2, L4_LShRU3, L4_LShRW3, L4_LShLU1, L4_LShLX1,
    L4_LShLU2, L4_LShLX2, L4_LShLU3, L4_LShLW3);
  ...
  q15_t_add((Q15_T*)(mem_buf + 76800), (Q15_T*)mem_buf, L4_N, L4_HOUT, L4_WOUT,
    ...
    L4_LScten1, L4_LScten2, L4_LScret);
  ...
  q15_convolution((Q15_T*)mem_buf, D1NW, (Q15_T*)mem_buf, L4_N, L4_HOUT,
    ...
    D1NW_Demote, D1NW_LScinput, D1NW_LScoutput, D1NW_LDemote);
  ...
  q15_convolution((Q15_T*)mem_buf, D1CW, (Q15_T*)(mem_buf + 153600), L4_N,
    ...
    D1CW_Scoutput, D1CW_Demote, D1CW_LScinput, D1CW_LScoutput, D1CW_LDemote);
  ...
  q15_t_add_vec((Q15_T*)(mem_buf + 153600), D1CB, L4_N, L4_HOUT, L4_WOUT,
    ...
    D1CB_LScten, D1CB_LScvec, D1CB_LScret);
  ...
  q15_convolution((Q15_T*)mem_buf, D1LW, (Q15_T*)(mem_buf + 153600), L4_N,
    ...
    D1LW_Scoutput, D1LW_Demote, D1LW_LScinput, D1LW_LScoutput, D1LW_LDemote);
  ...
  q15_t_add_vec((Q15_T*)(mem_buf + 153600), D1LB, L4_N, L4_HOUT, L4_WOUT,
    ...
    D1LB_LScten, D1LB_LScvec, D1LB_LScret);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L5_F1, L5_W1, L5_B1, L5_F2,
    ...
    L5_ShLX1, L5_ShLU2, L5_ShLX2, L5_ShLU3, L5_ShLW3, L5_LShRU1, L5_LShRX1,
    L5_LShRU2, L5_LShRX2, L5_LShRU3, L5_LShRW3, L5_LShLU1, L5_LShLX1,
    L5_LShLU2, L5_LShLX2, L5_LShLU3, L5_LShLW3);
  ...
  q15_t_add((Q15_T*)(mem_buf + 76800), (Q15_T*)mem_buf, L5_N, L5_HOUT, L5_WOUT,
    ...
    L5_LScten1, L5_LScten2, L5_LScret);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L6_F1, L6_W1, L6_B1, L6_F2,
    ...
    L6_ShLX1, L6_ShLU2, L6_ShLX2, L6_ShLU3, L6_ShLW3, L6_LShRU1, L6_LShRX1,
    L6_LShRU2, L6_LShRX2, L6_LShRU3, L6_LShRW3, L6_LShLU1, L6_LShLX1,
    L6_LShLU2, L6_LShLX2, L6_LShLU3, L6_LShLW3);
  ...
  q15_t_add((Q15_T*)(mem_buf + 76800), (Q15_T*)mem_buf, L6_N, L6_HOUT, L6_WOUT,
    ...
    L6_LScten1, L6_LScten2, L6_LScret);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L7_F1, L7_W1, L7_B1, L7_F2,
    ...
    L7_ShLX1, L7_ShLU2, L7_ShLX2, L7_ShLU3, L7_ShLW3, L7_LShRU1, L7_LShRX1,
    L7_LShRU2, L7_LShRX2, L7_LShRU3, L7_LShRW3, L7_LShLU1, L7_LShLX1,
    L7_LShLU2, L7_LShLX2, L7_LShLU3, L7_LShLW3);
  ...
  q15_t_add((Q15_T*)(mem_buf + 76800), (Q15_T*)mem_buf, L7_N, L7_HOUT, L7_WOUT,
    ...
    L7_LScten1, L7_LScten2, L7_LScret);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L8_F1, L8_W1, L8_B1, L8_F2,
    ...
    L8_ShLX1, L8_ShLU2, L8_ShLX2, L8_ShLU3, L8_ShLW3, L8_LShRU1, L8_LShRX1,
    L8_LShRU2, L8_LShRX2, L8_LShRU3, L8_LShRW3, L8_LShLU1, L8_LShLX1,
    L8_LShLU2, L8_LShLX2, L8_LShLU3, L8_LShLW3);
  ...
  q15_t_add((Q15_T*)(mem_buf + 76800), (Q15_T*)mem_buf, L8_N, L8_HOUT, L8_WOUT,
    ...
    L8_LScten1, L8_LScten2, L8_LScret);
  ...
  q15_convolution((Q15_T*)mem_buf, D2NW, (Q15_T*)mem_buf, L8_N, L8_HOUT,
    ...
    D2NW_Demote, D2NW_LScinput, D2NW_LScoutput, D2NW_LDemote);
  ...
  q15_convolution((Q15_T*)mem_buf, D2CW, (Q15_T*)(mem_buf + 168000), L8_N,
    ...
    D2CW_Scoutput, D2CW_Demote, D2CW_LScinput, D2CW_LScoutput, D2CW_LDemote);
  ...
  q15_t_add_vec((Q15_T*)(mem_buf + 168000), D2CB, L8_N, L8_HOUT, L8_WOUT,
    ...
    D2CB_LScten, D2CB_LScvec, D2CB_LScret);
  ...
  q15_convolution((Q15_T*)mem_buf, D2LW, (Q15_T*)(mem_buf + 172800), L8_N,
    ...
    D2LW_Scoutput, D2LW_Demote, D2LW_LScinput, D2LW_LScoutput, D2LW_LDemote);
  ...
  q15_t_add_vec((Q15_T*)(mem_buf + 172800), D2LB, L8_N, L8_HOUT, L8_WOUT,
    ...
    D2LB_LScten, D2LB_LScvec, D2LB_LScret);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L9_F1, L9_W1, L9_B1, L9_F2,
    ...
    L9_ShLX1, L9_ShLU2, L9_ShLX2, L9_ShLU3, L9_ShLW3, L9_LShRU1, L9_LShRX1,
    L9_LShRU2, L9_LShRX2, L9_LShRU3, L9_LShRW3, L9_LShLU1, L9_LShLX1,
    L9_LShLU2, L9_LShLX2, L9_LShLU3, L9_LShLW3);
  ...
  q15xq7_q15_mbconv_block((Q15_T*)mem_buf, L10_F1, L10_W1, L10_B1, L10_F2,
    ...
    L10_ShLU3, L10_ShLW3, L10_LShRU1, L10_LShRX1, L10_LShRU2, L10_LShRX2,
    L10_LShRU3, L10_LShRW3, L10_LShLU1, L10_LShLX1, L10_LShLU2, L10_LShLX2,
    L10_LShLU3, L10_LShLW3);
  ...
  q15_t_add((Q15_T*)mem_buf, (Q15_T*)(mem_buf + 96000), L10_N, L10_HOUT,
    ...
    L10_LScten1, L10_LScten2, L10_LScret);
  ...
  q15xq7_q15_mbconv_block((Q15_T*)mem_buf, L11_F1, L11_W1, L11_B1, L11_F2,
    ...
    L11_ShLU3, L11_ShLW3, L11_LShRU1, L11_LShRX1, L11_LShRU2, L11_LShRX2,
    L11_LShRU3, L11_LShRW3, L11_LShLU1, L11_LShLX1, L11_LShLU2, L11_LShLX2,
    L11_LShLU3, L11_LShLW3);
  ...
  q15_t_add((Q15_T*)mem_buf, (Q15_T*)(mem_buf + 96000), L11_N, L11_HOUT,
    ...
    L11_LScten1, L11_LScten2, L11_LScret);
  ...
  q15_convolution((Q15_T*)(mem_buf + 96000), D3NW, (Q15_T*)(mem_buf + 96000),
    ...
    D3NW_Scoutput, D3NW_Demote, D3NW_LScinput, D3NW_LScoutput, D3NW_LDemote);
  ...
  q15_convolution((Q15_T*)(mem_buf + 96000), D3CW, (Q15_T*)(mem_buf + 61200),
    ...
    D3CW_Scinput, D3CW_Scoutput, D3CW_Demote, D3CW_LScinput, D3CW_LScoutput,
    D3CW_LDemote);
  ...
  q15_t_add_vec((Q15_T*)(mem_buf + 61200), D3CB, L11_N, L11_HOUT, L11_WOUT,
    ...
    D3CB_LScten, D3CB_LScvec, D3CB_LScret);
  ...
  q15_convolution((Q15_T*)(mem_buf + 96000), D3LW, (Q15_T*)(mem_buf + 60000),
    ...
    D3LW_Scinput, D3LW_Scoutput, D3LW_Demote, D3LW_LScinput, D3LW_LScoutput,
    D3LW_LDemote);
  ...
  q15_t_add_vec((Q15_T*)(mem_buf + 60000), D3LB, L11_N, L11_HOUT, L11_WOUT,
    ...
    D3LB_LScten, D3LB_LScvec, D3LB_LScret);
  ...
  q15xq7_q7_mbconv_block((Q15_T*)mem_buf, L12_F1, L12_W1, L12_B1, L12_F2,
    ...
    L12_ShLU3, L12_ShLW3, L12_LShRU1, L12_LShRX1, L12_LShRU2, L12_LShRX2,
    L12_LShRU3, L12_LShRW3, L12_LShLU1, L12_LShLX1, L12_LShLU2, L12_LShLX2,
    L12_LShLU3, L12_LShLW3);
  ...
  q7_mbconv_block((Q7_T*)(mem_buf + 76800), L13_F1, L13_W1, L13_B1, L13_F2,
    ...
    L13_ShLU3, L13_ShLW3, L13_LShRU1, L13_LShRX1, L13_LShRU2, L13_LShRX2,
    L13_LShRU3, L13_LShRW3, L13_LShLU1, L13_LShLX1, L13_LShLU2, L13_LShLX2,
    L13_LShLU3, L13_LShLW3);
  ...
  q7_t_add((Q7_T*)(mem_buf + 76800), (Q7_T*)mem_buf, L13_N, L13_HOUT, L13_WOUT,
    ...
    L13_LScten1, L13_LScten2, L13_LScret);
  ...
  q7_mbconv_block((Q7_T*)(mem_buf + 76800), L14_F1, L14_W1, L14_B1, L14_F2,
    ...
    L14_ShLU3, L14_ShLW3, L14_LShRU1, L14_LShRX1, L14_LShRU2, L14_LShRX2,
    L14_LShRU3, L14_LShRW3, L14_LShLU1, L14_LShLX1, L14_LShLU2, L14_LShLX2,
    L14_LShLU3, L14_LShLW3);
  ...
  q7_t_add((Q7_T*)(mem_buf + 76800), (Q7_T*)mem_buf, L14_N, L14_HOUT, L14_WOUT,
    ...
    L14_LScten1, L14_LScten2, L14_LScret);
  ...
  q7xq15_q7_convolution((Q7_T*)(mem_buf + 76800), D4CW,
    ...
    D4CW_HDILATION, D4CW_WDILATION, D4CW_Scinput, D4CW_Scoutput, D4CW_Demote,
    D4CW_LScinput, D4CW_LScoutput, D4CW_LDemote);
  ...
  q7xq15_q7_t_add_vec((Q7_T*)(mem_buf + 4800), D4CB, L14_N, L14_HOUT,
    ...
    D4CB_LScten, D4CB_LScvec, D4CB_LScret);
  ...
  q7xq15_q15_convolution((Q7_T*)(mem_buf + 76800), D4LW,
    ...
    D4LW_LScinput, D4LW_LScoutput, D4LW_LDemote);

  q15_t_add_vec((Q15_T*)(mem_buf + 2400), D4LB, L14_N, L14_HOUT, L14_WOUT,
    D4LW_COUT, (Q15_T*)(mem_buf + 2400), D4LB_Scten, D4LB_Scvec, D4LB_Scret,
    D4LB_LScten, D4LB_LScvec, D4LB_LScret);
