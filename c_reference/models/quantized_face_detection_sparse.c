...
void q_face_detection_sparse(char* const mem_buf) {
  ...
  q15_convolution((Q15_T*)mem_buf, D1NW, (Q15_T*)mem_buf,
    ...
    D1NW_Scoutput, D1NW_Demote, D1NW_LScinput, D1NW_LScoutput, D1NW_LDemote);
  ...
  q15_convolution((Q15_T*)mem_buf, D1LW, (Q15_T*)(mem_buf + 168960),
    ...
    D1LW_Scinput, D1LW_Scoutput, D1LW_Demote, D1LW_LScinput, D1LW_LScoutput,
    D1LW_LDemote);
  ...
  q15_t_add((Q15_T*)(mem_buf + 76800), (Q15_T*)mem_buf, L2_N, L2_HOUT,
    L2_WOUT, L2_COUT, (Q15_T*)(mem_buf + 76800), L2_Scten1, L2_Scten2,
    L2_Scret, L2_LScten1, L2_LScten2, L2_LScret);
  ...
  q15_convolution((Q15_T*)mem_buf, D2NW, (Q15_T*)mem_buf,
    ...
    D2NW_Scoutput, D2NW_Demote, D2NW_LScinput, D2NW_LScoutput, D2NW_LDemote);
  ...
  q15_convolution((Q15_T*)mem_buf, D2LW, (Q15_T*)(mem_buf + 153600),
    ...
    D2LW_Scinput, D2LW_Scoutput, D2LW_Demote, D2LW_LScinput, D2LW_LScoutput,
    D2LW_LDemote);
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 76800), L3_F1, L3_W1, L3_B1, L3_F2,
    L3_W2, L3_B2, L3_F3, L3_W3, L3_B3, (Q15_T*)mem_buf, (Q15_T*)(mem_buf + 38400),
    ...
    L3_ShLU3, L3_ShLW3, L3_LShRU1, L3_LShRX1, L3_LShRU2, L3_LShRX2, L3_LShRU3,
    L3_LShRW3, L3_LShLU1, L3_LShLX1, L3_LShLU2, L3_LShLX2, L3_LShLU3,
    L3_LShLW3);
  ...
  q15_convolution((Q15_T*)(mem_buf + 38400), D3CW, (Q15_T*)(mem_buf + 94720),
    L3_N, L3_HOUT, L3_WOUT, D3NW_COUT * D3NW_G, D3CW_HF, D3CW_WF, D3CW_CF,
    D3CW_COUT, L3_HOUT, L3_WOUT, D3CW_G, D3CW_HPADL, D3CW_HPADR, D3CW_WPADL,
  ...
  q15_convolution((Q15_T*)mem_buf, D4CW, (Q15_T*)(mem_buf + 40960),
    ...
    D4CW_Scoutput, D4CW_Demote, D4CW_LScinput, D4CW_LScoutput, D4CW_LDemote);
  ...
  q15_convolution((Q15_T*)mem_buf, D4LW, (Q15_T*)(mem_buf + 45824),
    ...
    D4LW_Scinput, D4LW_Scoutput, D4LW_Demote, D4LW_LScinput, D4LW_LScoutput,
    D4LW_LDemote);
