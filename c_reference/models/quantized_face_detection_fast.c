...
void q_face_detection_fast(char* const mem_buf) {
  ...
  q15_convolution((Q15_T*)(mem_buf + 38400), D1NW, (Q15_T*)(mem_buf + 38400),
    L1_N, L1_HOUT, L1_WOUT, L1_COUT, D1NW_HF,
  ...
  q15_convolution((Q15_T*)(mem_buf + 38400), D1CW, (Q15_T*)mem_buf,
    L1_N, L1_HOUT, L1_WOUT, D1NW_COUT * D1NW_G,
  ...
  q15_mbconv_block((Q15_T*)(mem_buf + 19200), L2_F1, L2_W1, L2_B1, L2_F2, L2_W2,
    L2_B2, L2_F3, L2_W3, L2_B3, (Q15_T*)(mem_buf + 38400),
    (Q15_T*)(mem_buf + 6000), (Q15_T*)(mem_buf + 256), L2_N, L2_H, L2_W, L2_CIN,
    L2_CTEMP, L2_HF, L2_WF, L2_COUT, L2_HOUT, L2_WOUT, L2_HPADL, L2_HPADR,
    L2_WPADL, L2_WPADR, L2_HSTRIDE, L2_WSTRIDE, L2_Limit1, L2_Limit2, L2_ShRU1,
    L2_ShRX1, L2_ShRU2, L2_ShRX2, L2_ShRU3, L2_ShRW3, L2_ShLU1, L2_ShLX1,
    L2_ShLU2, L2_ShLX2, L2_ShLU3, L2_ShLW3);
  ...
  q15_convolution((Q15_T*)(mem_buf + 96000), D2NW, (Q15_T*)(mem_buf + 96000),
    L2_N, L2_HOUT, L2_WOUT, L2_COUT, D2NW_HF,
  ...
  q15_convolution((Q15_T*)(mem_buf + 96000), D2CW, (Q15_T*)mem_buf,
    L2_N, L2_HOUT, L2_WOUT, D2NW_COUT * D2NW_G,
  ...
  // MBConv Layer 3
  q15xq7_q15_mbconv_block((Q15_T*)(mem_buf + 38400), L3_F1, L3_W1, L3_B1, L3_F2,
    L3_W2, L3_B2, L3_F3, L3_W3, L3_B3, (Q15_T*)(mem_buf + 96000),
  ...
  q15_convolution((Q15_T*)(mem_buf + 8400), D3NW, (Q15_T*)(mem_buf + 8400),
    L4_N, L4_HOUT, L4_WOUT, L4_COUT, D3NW_HF,
  ...
  q15_convolution((Q15_T*)(mem_buf + 8400), D3CW, (Q15_T*)(mem_buf + 89808),
    L4_N, L4_HOUT, L4_WOUT, D3NW_COUT * D3NW_G,
