...
void q_face_detection_fast(char* const mem_buf) {
  ...
  for (ITER_T patchX = 0; patchX < 14; patchX++) {
    for (ITER_T patchY = 0; patchY < 19; patchY++) {
      q7xq15_q15_rnnpool_block((Q7_T*)(mem_buf + 76800 + ((5120 * patchX) + (32 * patchY))),
        ...
        (const void*)(&RNN2_LOG_SCALES), (Q15_T*)(mem_buf + 19204),
        (Q15_T*)(mem_buf + 21252), ShR1, ShL1, ShR2, ShL2, LShR1, LShL1, LShR2,
        LShL2);
  ...
  q15_t_add_vec((Q15_T*)mem_buf, D1CB, L1_N, L1_HOUT, L1_WOUT, D1CW_COUT,
    (Q15_T*)mem_buf, D1CB_Scten, D1CB_Scvec, D1CB_Scret, D1CB_LScten,
    D1CB_LScvec, D1CB_LScret);
